...
if (typeof tinyMCE != 'undefined') {
    ...
    tinyMCE.init({
        ...
        theme_advanced_blockformats: "p,h2,h3,h4,h5,pre",
        ...
        valid_elements : ""
            ...
            + "-div,"
            + "",
        extended_valid_elements: "pre[style|class],"
            ...
            + "h2[class<clearfix],h3[class<clearfix],h4[class<clearfix],h5[class<clearfix],"
